...
import Q1.Employee;
import Q1.Project;
import Q1.ProjectSerializer;
import Q1.ProjectDeSerializer;
...
public class ThreadImplementation {
	...
	//	projectSerializer.projectMap1 = new HashMap <Project,ArrayList<Employee>>();
		...
		Employee e1 = new Employee("E001","varsha","93839933933","RTNagar",1000);
		Employee e2 = new Employee("E002","jagan","93546333933","Jayanagar",2000);
		Employee e3 = new Employee("E003","manar","938396833","Malleswaram",1500);
		Employee e4 = new Employee("E004","kunal","9334593933","Vijayanagar",3000);
		Employee e5 = new Employee("E005","eshwar","9383678933","Indiranagar",2000);
		Employee e6 = new Employee("E006","uday","9385493933","KRPuram",1750);
		Employee e7 = new Employee("E007","raki","9383978933","Koramangala",4000);
		Employee e8 = new Employee("E008","dinu","9383992133","Malleswaram",3000);
		Employee e9 = new Employee("E009","sunny","9345193933","RTNagar",2000);
		Employee e10 = new Employee("E010","abhy","9383975673","Koramangala",4000);
		Employee e11 = new Employee("E011","suary","9383992789","Malleswaram",3000);
		Employee e12 = new Employee("E012","yash","9345193763","RTNagar",2000);
